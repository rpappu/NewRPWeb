...
<div class="intro-text">
  A collection of projects I've worked on over the years, spanning research, commercial development, and innovation initiatives.
</div>
...
const projects = [
  {
    title: "Metriq",
    description: "How does quantum computing Platform X running software stack Y perform on workload Z and how has that changed over time?. Working with Will Zeng and Nathan Shammah, I conceived of this concept and funded early development.",
    year: 2012,
    type: "Innovation",
    status: "completed",
